...
pipeline {
    ...
    parameters {
        ...
        choice(name: 'DOCKER_REGISTRY', choices:['nasruddin/locator-service'], description: 'docker registry')
    ...
    stages {
        ...
        stage('Docker Build') {
            ...
            steps {
                ...
                def imageName = bat ('mvn help:evaluate -Dexpression=jkube.generator.name -q -DforceStdout -Ddocker.registry=${DOCKER_REGISTRY} -Djkube.namespace=${NAMESPACE} -Dbuild.number=${BUILD_NUMBER}', returnStdout: true)
