    ...
    stages {
        ...
        stage('Docker Build') {
            ...
            steps {
                ...
                imageName = bat ('mvn help:evaluate -Dexpression=jkube.generator.name -q -DforceStdout -Ddocker.registry=${DOCKER_REGISTRY} -Djkube.namespace=${NAMESPACE} -Dbuild.number=${BUILD_NUMBER}', returnStdout: true)
